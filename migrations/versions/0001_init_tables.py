...
def upgrade() -> None:
    ...
    op.create_index("ix_test_case_external_id", "test_case", ["external_id"], unique=True)
    ...
    op.create_table(
        ...
        sa.Column("test_external_id", sa.String(length=512), nullable=False),
    ...
    op.create_index("ix_test_result_test_external_id", "test_result", ["test_external_id"])


def downgrade() -> None:
    op.drop_index("ix_test_result_test_external_id", table_name="test_result")
